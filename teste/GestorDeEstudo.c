...
void gerarCronograma(Cronograma *cronograma){
   ...
   // fclose(lista);   // Fecha o arquivo apois a leitura
    ...
    Sleep(1000);
    printf("OBS: SERA EMITIDO 2 BEEP COMO ALERTA ASSIM QUE ATINGIDO O TEMPO DE ESTUDO DE CADA DISCIPLINA\n");
    Sleep(1000);
